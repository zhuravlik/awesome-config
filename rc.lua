...
--bright_color="#cacaca"   -- Color to highlight widget elements
--bright_color="#E1C596"   -- Color to highlight widget elements
--bright_color="#1a1a1a"   -- Color to highlight widget elements
--bright_color="#f3f2f8"   -- Color to highlight widget elements
...
bashets.register(datew, "date.sh", '<span weight="bold">  $1  </span>', 60, '|')
...
--bgi = image("/home/anton/tst/Vienna VWindowFrameBottom.tga")
--bgi = image("/home/anton/tst/Vienna VStartPanelLogoff.tga")
--bgi2 = image("/home/anton/tst/Vienna VWindowFrameTop.tga")
--bgi = bgi:crop_and_scale(0, 0, 643, 18, 1280, 23)
--bgi2 = bgi:rotate(math.pi / 8)
--bgi2 = bgi
--bgi = bgi:crop_and_scale(0, 0, 407, 31, 1280, 23)
--bgi2 = bgi2:crop_and_scale(0, 0, 643, 18, 1280, 23)
--/usr/share/icons/Tango/128x128/actions/format-text-strikethrough.png")
for s = 1, screen.count() do
...
--    topbar[s].bg_image = bgi
--    topbar[s].bg = "#ffffff00"
    bottombar[s] = awful.wibox({ position = "bottom", screen = s})
--    bottombar[s].bg_image = bgi2
--    bottombar[s].bg = "#ffffff00"
    ...
    topbar[s].widgets = {gapw, gapw, gapw, datew, ww, xkbw, mysystray, gapw,
    		{mylauncher, gapw,  mytaglist[s], mytasklist[s], layout = awful.widget.layout.horizontal.leftright},
		layout = awful.widget.layout.horizontal.rightleft
    }
end
-- }}}
...
--bg="#ffffff00"
--bgi = bgi:crop_and_scale(0, 0, calendtext:extents().width, calendtext:extents().height, calendtext:extents().width, calendtext:extents().height)
calendbox = wibox({width=calendtext:extents().width, height=100, bg="#ffffff00"})
calendbox.widgets = {calendtext, layout = awful.widget.layout.horizontal.leftright}
calendbox:geometry({x=1280 - calendtext:extents().width - 30, y=40})
calendbox.screen = mouse.screen
--calendbox.bg_image = bgi

--mailtext = widget({type="textbox", name="mailtext"})
--mailtext.text = awful.util.pread("/usr/share/awesome/bashets/fullmail.sh") 
--mailbox = wibox({width=mailtext:extents().width, height=mailtext:extents().height, bg="#ffffff00"})
--mailbox.widgets = {mailtext, layout = awful.widget.layout.horizontal.leftright}
--mailbox:geometry({x=30, y=1024 - mailtext:extents().height - 30})
--mailbox.screen = mouse.screen
--bashets.register(mailtext, "fullmail.sh", "<span face=\"Monospace\">$1</span>", 3600, '|')
...
psbox:geometry({x=30, y=1024 - 50 - pstext:extents().height})
